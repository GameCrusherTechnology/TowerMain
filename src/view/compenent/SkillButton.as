package view.compenent
{
	...
	public class SkillButton extends Sprite
	{
		...
		public function SkillButton(_side:Number)
		{
			side = _side;
			...
			var icon:Image = new Image(Game.assets.getTexture("quickPassCardIcon"));
			icon.width = icon.height = side*0.8;
			container.addChild(icon);
			icon.x = side*0.1;
			
			var label:TextField = FieldController.createNoFontField(300,side/4,LanguageController.getInstance().getString("skill"),0x000000,0,true);
